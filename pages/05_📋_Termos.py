...
with st.sidebar:
    ...
    email_destinatario = st.text_input("Enviar para (Destinatários):", value="financeiro@crti.com.br,tayna@crti.com.br,kamille.voitach@crti.com.br,camille@crti.com.br", key="hom_email_dest_key")
