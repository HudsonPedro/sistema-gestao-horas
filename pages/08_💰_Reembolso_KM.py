        ...
        with st.spinner("⏳ Estruturando arquivos gêmeos PDF e Excel..."):
            try:
                ...
                if caminho_imagem_disco and os.path.exists(caminho_imagem_disco):
                    ws.write("B14", f"COMPROVANTE DE ABASTECIMENTO ANEXADO", f_subc)
                    ws.insert_image(l_f + 7, 0, caminho_imagem_disco, {"x_scale": 1.0, "y_scale": 1.0}) #{"x_scale": 0.42, "y_scale": 0.42}) # l_f + 3, 2
