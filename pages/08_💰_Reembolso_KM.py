...
# --- CLASSE PDF LIMPA (ORIENTAÇÃO PAISAGEM CONFORME LEIAUTE SOLICITADO) ---
...
st.write("Layout estruturado via código interno para PDF e Excel sincronizados, com suporte a anexo de abastecimento.")
st.markdown("---")
